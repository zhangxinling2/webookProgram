...
import (
	context "context"
	reflect "reflect"
	dao "webookProgram/webook/internal/repository/dao"
...
func (m *MockUserDAO) EditUser(ctx context.Context, u dao.User) (dao.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EditUser", ctx, u)
...
func (mr *MockUserDAOMockRecorder) EditUser(ctx, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditUser", reflect.TypeOf((*MockUserDAO)(nil).EditUser), ctx, u)
}
...
func (m *MockUserDAO) FindByPhone(ctx context.Context, email string) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDAOMockRecorder) FindByPhone(ctx, email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByPhone", reflect.TypeOf((*MockUserDAO)(nil).FindByPhone), ctx, email)
}
